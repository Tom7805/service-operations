/**
 * Định nghĩa kiểu dữ liệu cho mô-đun Cơ hội bán hàng & Lập báo giá
 * Tuân thủ Backend API Contract NCL-03-CN-001, NCL-03-CN-002, NCL-03-CN-003
 */

export type OpportunityStage =
  | 'APPROACH'    // Tiếp cận (10% xác suất) - giai đoạn khởi tạo (QTN-06)
  | 'PROPOSAL'    // Đề xuất giải pháp (40% xác suất) - giai đoạn bắt buộc để lập báo giá (NCL-03-CN-003)
...
export type OpportunityFormErrors = Record<string, string>;
...
/** Dòng báo giá gửi lên máy chủ (NCL-03-CN-003) */
export interface QuoteItemReq {
  professionalRole: string;
  workDays: number;
}

/** Yêu cầu lập báo giá cho cơ hội (POST /opportunities/{id}/quotes) */
...
/** Bản ghi báo giá hoàn chỉnh từ máy chủ (NCL-03-CN-003) */
...
export const STAGE_CONFIGS: Record<OpportunityStage, StageMeta> = {
  ...
  PROPOSAL: {
    ...
    description: 'Trình bày giải pháp kỹ thuật, lập báo giá dự toán dịch vụ (NCL-03-CN-003)',
  },
  NEGOTIATION: {
    key: 'NEGOTIATION',
