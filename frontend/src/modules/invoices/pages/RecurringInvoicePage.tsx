 ...
 * hợp đồng duy trì (MAINTENANCE) — ngày lập trong tháng + số tiền cố định. Đúng
 * theo AC của story: hệ thống TỰ ĐỘNG tạo hóa đơn nháp tới đúng ngày (job nền
 * `RecurringInvoiceScheduler`), không có yêu cầu nút chạy tay ở đây.
 */
  ...
  return (
    <div className="user-management-page">
      ...
      <p className="page-subtitle" style={{ marginBottom: '16px' }}>
        Khai báo lịch lập hóa đơn hàng tháng cho hợp đồng duy trì (Maintenance) — hệ thống tự động tạo hóa đơn
        nháp đúng ngày đã khai, kế toán soát lại rồi phát hành.
      </p>
