...
export const BUSINESS_NAV_ITEMS: NavItem[] = [
  ...
  {
    tab: 'INVOICES', icon: ICONS.receipt, label: 'Hóa đơn', requires: ['VT-05'],
    // NCL-10-CN-003: Kế toán xem danh sách hóa đơn kèm số đã thu/còn lại, mở chi tiết một
    // hóa đơn để xem lịch sử thanh toán và ghi nhận một khoản khách hàng vừa thanh toán.
  },
  {
