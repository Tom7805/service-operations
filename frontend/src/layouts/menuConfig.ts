...
export const SALES_NAV_ITEMS: NavItem[] = [
  { tab: 'CUSTOMERS', icon: ICONS.building, label: 'Khách hàng', requires: ['VT-04', 'VT-02'] },
  {
    ...
    // các vai trò còn lại thay vì hiện "chỉ xem" rồi báo lỗi khi bấm vào.
  },
...
/** Nghiệm thu & Bàn giao — nghiệm thu hạng mục và sản phẩm bàn giao (Epic 12). */
export const DELIVERY_NAV_ITEMS: NavItem[] = [
  {
    tab: 'ACCEPTANCES', icon: ICONS.check, label: 'Nghiệm thu hạng mục', matches: ['ACCEPTANCE_DETAIL'],
    requires: ['VT-02'],
  ...
  {
    tab: 'DELIVERABLES', icon: ICONS.folder, label: 'Sản phẩm bàn giao', requires: ['VT-02'],
...
/** Báo cáo — trung tâm báo cáo vận hành (Epic 11) và xuất tệp. */
export const REPORT_NAV_ITEMS: NavItem[] = [
  {
    tab: 'REPORTS', icon: ICONS.document, label: 'Báo cáo',
    matches: [
      'PIPELINE_REPORT', 'OPERATIONAL_DASHBOARD', 'UTILIZATION_REPORT', 'PROJECT_PERFORMANCE_REPORT',
      'REVENUE_REPORT', 'TIMESHEET_REPORT',
    ],
    ...
    // vận hành NCL-11-CN-001: VT-01; tỷ lệ giờ tính phí NCL-11-CN-002: VT-01; hiệu quả theo dự án
    // NCL-11-CN-003: VT-02; doanh thu theo tháng NCL-11-CN-005: VT-01/VT-05; giờ công theo nhân sự
    // NCL-11-CN-006: VT-02), trang báo cáo cũng tự chặn vai trò không đúng.
  },
  {
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'delivery', label: 'Nghiệm thu & Bàn giao', paletteLabel: 'Nghiệm thu & Bàn giao', items: DELIVERY_NAV_ITEMS },
