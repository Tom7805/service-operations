...
import RecurringInvoicePage from './modules/invoices/pages/RecurringInvoicePage';
    ...
    <div className="app-frame">
      ...
      <div className="app-shell">
        ...
        <main className="app-content" id="noi-dung-chinh" tabIndex={-1} key={activeTab}>
          ...
          ) : activeTab === 'RECURRING_INVOICE' ? (
            <RecurringInvoicePage currentUserRoles={currentRoles} currentUserName={session.fullName} />
