...
import ReceivableAgingPage from './modules/invoices/pages/ReceivableAgingPage';
    ...
    <div className="app-frame">
      ...
      <div className="app-shell">
        ...
        <main className="app-content" id="noi-dung-chinh" tabIndex={-1} key={activeTab}>
          ...
          ) : activeTab === 'RECEIVABLE_AGING' ? (
            <ReceivableAgingPage currentUserRoles={currentRoles} currentUserName={session.fullName} />
