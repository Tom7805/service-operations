...
import MilestoneInvoicePage from './modules/invoices/pages/MilestoneInvoicePage';
    ...
    <div className="app-frame">
      ...
      <div className="app-shell">
        ...
        <main className="app-content" id="noi-dung-chinh" tabIndex={-1} key={activeTab}>
          ...
          ) : activeTab === 'MILESTONE_INVOICE' ? (
            <MilestoneInvoicePage currentUserRoles={currentRoles} currentUserName={session.fullName} />
