...
| `INVALID_STATE` | 400 | Thao tác chuyển trạng thái không hợp lệ, hoặc vi phạm ràng buộc nghiệp vụ (ví dụ ngày kết thúc sớm hơn ngày bắt đầu, thêm hoạt động chăm sóc vào cơ hội đã đóng, hoặc ghi giờ công cho dự án đã đóng/ngày ở tương lai) | `NCL-01-CN-002`, `NCL-01-CN-003`, `NCL-01-CN-007`, `NCL-03-CN-006`, `NCL-06-CN-001` |
